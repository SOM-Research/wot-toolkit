 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.wot.td.impl.PSKSecuritySchemeImpl#getIdentity <em>Identity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PSKSecuritySchemeImpl extends SecuritySchemeImpl implements PSKSecurityScheme {
	...
	protected EClass eStaticClass() {
		return TdPackage.Literals.PSK_SECURITY_SCHEME;
	}
	...
	public void setIdentity(String newIdentity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.PSK_SECURITY_SCHEME__IDENTITY, oldIdentity,
					identity));
	}
