...
public class ArraySchemaItemProvider extends DataSchemaItemProvider {
	...
	protected void addItemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ArraySchema_items_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ArraySchema_items_feature",
								"_UI_ArraySchema_type"),
						TdPackage.Literals.ARRAY_SCHEMA__ITEMS, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((ArraySchema) object).getType();
