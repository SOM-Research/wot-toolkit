...
public class BearerSecuritySchemeImpl extends SecuritySchemeImpl implements BearerSecurityScheme {
	...
	protected EClass eStaticClass() {
		return TdPackage.Literals.BEARER_SECURITY_SCHEME;
	}
	...
	public void setAlg(String newAlg) {
		...
		alg = newAlg;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.BEARER_SECURITY_SCHEME__ALG, oldAlg, alg));
	}
	...
	public void setIn(String newIn) {
		...
		in = newIn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.BEARER_SECURITY_SCHEME__IN, oldIn, in));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.BEARER_SECURITY_SCHEME__NAME, oldName,
					name));
	}
