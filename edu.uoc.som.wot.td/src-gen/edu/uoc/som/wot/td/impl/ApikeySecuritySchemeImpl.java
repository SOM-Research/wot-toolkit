...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Apikey Security Scheme</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ApikeySecuritySchemeImpl extends SecuritySchemeImpl implements ApikeySecurityScheme {
	...
	protected EClass eStaticClass() {
		return TdPackage.Literals.APIKEY_SECURITY_SCHEME;
	}
	...
	public void setIn(String newIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.APIKEY_SECURITY_SCHEME__IN, oldIn, in));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TdPackage.APIKEY_SECURITY_SCHEME__NAME, oldName,
					name));
	}
